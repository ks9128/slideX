...
function Hero() {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-16 sm:mt-28 space-y-4 px-4">
      <h2 className="font-bold text-3xl sm:text-5xl text-center">
        {" "}
        From Idea to <span className="text-primary">Presentation</span> in One
        Click⚡
      </h2>
      <p className="text-base sm:text-xl text-gray-500 max-w-2xl text-center ">
      ...
      <div className="relative max-w-3xl mt-10 w-full">
        <HeroVideoDialog
          className="block dark:hidden w-full"
          animationStyle="from-center"
          videoSrc="https://www.youtube.com/embed/xgTlJS_-94A"
